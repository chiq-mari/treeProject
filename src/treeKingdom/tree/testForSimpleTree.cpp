...
int main()
{
    ...
    Person person6(7652970,"Hilary","Murrie","Male",67,4690818,0,0,1);
    ...
    Person person9(9669780,"Daniella","Cockburn","Female",65,7652970,0,0,0);
    Person person10(9977012,"Michel","Burless","Female",64,9054378,0,0,0);
    Person person11(10816975,"Fifine","Wigfall","Female",60,6171932,0,0,0);
    ...
    Person person14(15088813,"Doug","Garbutt","Male",53,6577415,0,0,0);
    Person person15(16788635,"Mallory","Cordova","Male",52,6577415,0,0,0);
    Person person16(17057430,"Angeline","Whear","Female",51,9669780,0,0,0);
    Person person17(17813938,"Kari","Remmers","Female",50,13057926,0,0,0);
    ...
    Person person20(21769756,"Hi","Ivashev","Male",49,9648860,0,0,0);
    ...
    Person person30(29182614,"Lea","Hussy","Female",39,12938948,0,0,0);
