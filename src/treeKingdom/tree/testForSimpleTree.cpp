...
int main()
{
    ...
    Person person3(4911800,"Ariadne","Marchenko","Female",69,3205117,1,0,0);
    Person person4(6171932,"Roch","Jillard","Female",65,4911800,1,0,0);
    Person person5(6577415,"Andree","Dupre","Female",68,4911800,1,0,0);
    Person person6(7652970,"Hilary","Murrie","Male",67,4690818,1,0,1);
    Person person7(9054378,"Lilllie","Collister","Female",66,4690818,1,0,0);
    Person person8(9648860,"Binky","Leggen","Male",60,7652970,1,0,0);
    ...
    Person person12(12938948,"Yoko","Bracci","Female",55,6171932,1,0,0);
    Person person13(13057926,"Merell","Millsap","Male",54,9054378,1,0,0);
    Person person14(15088813,"Doug","Garbutt","Male",53,6577415,1,0,0);
    Person person15(16788635,"Mallory","Cordova","Male",52,6577415,1,0,0);
    ...
    Person person18(19092938,"Barbie","Fludder","Female",20,10816975,1,0,0);
    Person person19(19477947,"Garner","Jira","Male",20,9648860,1,0,0);
    Person person20(21769756,"Hi","Ivashev","Male",49,9648860,1,0,0);
    Person person21(23039858,"Rania","Lepick","Female",48,9669780,1,0,0);
    Person person22(23431360,"Martguerita","Gero","Female",47,13057926,1,0,0);
    Person person23(23831391,"Dodi","Cowins","Female",44,9977012,1,0,0);
    ...
    Person person28(28461813,"Nanni","Rymmer","Female",42,16788635,1,0,0);
    Person person29(29076978,"Dreddy","Scinelli","Female",40,15088813,1,0,0);
    Person person30(29182614,"Lea","Hussy","Female",39,12938948,1,0,0);
    Person person31(29344611,"Daniel","Presswell","Male",38,12938948,1,0,0);
