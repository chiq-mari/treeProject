...
int main()
{
    ...
    Person people2{30392967, "Mariangeles", "Mavarez", "female", 21, 7831768, 1, 1, 1};
    Person people3{7831768, "Ana", "Rangel", "female", 56, 3565988, 0, 1, 0};
    ...
    cout<<people2.hasFather(people3);
}